...
decision_response = client.chat.completions.create(
    model="gpt-4o-mini",
    messages=[
        {"role": "system", "content": "You are an ADF drift governance agent. Return only valid JSON."},
...
if only_in_azure or only_in_github:
    branch_name = "auto-fix-pipelineV4"
